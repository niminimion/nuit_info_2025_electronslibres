<div align="center">
  <h1>🖥️ NIRD OS</h1>
  <h3>Numérique Inclusif, Responsable et Durable</h3>
  <p><em>An Operating System to fight Planned Obsolescence.</em></p>
  <p><em>Un Système d'Exploitation pour lutter contre l'Obsolescence Programmée.</em></p>
...
### 📖 À Propos
**NIRD OS** est une simulation de système d'exploitation web créée pour la **Nuit de l'Info**. 
Notre mission : sensibiliser à l'impact écologique du numérique et démontrer que des logiciels légers (comme Linux) peuvent sauver de vieux ordinateurs de la déchetterie.
...
### 📖 About
**NIRD OS** is a web-based operating system simulation created for **Nuit de l'Info**.
Our mission: raise awareness about the ecological impact of digital technology and demonstrate that lightweight software (like Linux) can save old computers from the landfill.
